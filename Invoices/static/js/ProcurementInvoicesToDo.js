$(function () {
    ...
    document.getElementById("sbmtBTN").addEventListener("click", function () {
        ...
        $.ajax({
            url: "/system/Invoices/ProcurementToDo/table/api/",
            method: "GET",
            dataType: "json",
            data: {
            ...
            success: function (t) {
                ...
                t.forEach((element) => {
                    ...
                    <button class="btn btn-success" style="margin:5px auto;width:100%;" type="button" onclick="ViewApproveInvoiceModal('${element.id}', '${element.invoice_id}')"><i class="fa-solid fa-check"></i> Approve</button>
                    <button class="btn btn-danger" style="margin:5px auto;width:100%;" type="button" onclick="ViewRejectInvoiceModal('${element.id}', '${element.invoice_id}')"><i class="fa-solid fa-xmark"></i> Reject</button>`;
                });
                updateTableData(t);
            },
        });
...
function ViewInvoiceModal(rowid) {
    ...
    $.ajax({
        url: "/system/Invoices/ProcurementToDo/details/api/",
        method: "GET",
        dataType: "json",
        data: {
            'id': rowid,
...
function ViewApproveInvoiceModal(rowid, invoice_id) {
    var e = $("#pendingInvoicesTbl");
    rowData = e.bootstrapTable('getRowByUniqueId', rowid);
    console.log(rowData);
    document.getElementById('approve_invoice_id').innerHTML = invoice_id;
    document.getElementById('approve_vendor').innerHTML = rowData.vendor;
    document.getElementById('approve_date').innerHTML = rowData.date;
    document.getElementById('approve_po').innerHTML = rowData.po;
    document.getElementById('approve_bill_to').innerHTML = rowData.bill_to;
    document.getElementById('approve_submitted_by').innerHTML = rowData.user;
    document.getElementById('approve_timestamp').innerHTML = rowData.timestamp;
    document.getElementById('ap_invoice_id').value = rowData.id;
    $('#approve_action_modal').modal({
        backdrop: true,
        keyboard: true,
        focus: true,
        show: true,
...
function ViewRejectInvoiceModal(rowid, invoice_id) {
    var e = $("#pendingInvoicesTbl");
    rowData = e.bootstrapTable('getRowByUniqueId', rowid);
    console.log(rowData);
    // console.log(e.bootstrapTable('getRowByUniqueId', rowid).eng_name);
    document.getElementById('reject_invoice_id').innerHTML = invoice_id;
    document.getElementById('reject_vendor').innerHTML = rowData.vendor;
    document.getElementById('reject_date').innerHTML = rowData.date;
    document.getElementById('reject_po').innerHTML = rowData.po;
    document.getElementById('reject_bill_to').innerHTML = rowData.bill_to;
    document.getElementById('reject_submitted_by').innerHTML = rowData.user;
    document.getElementById('reject_timestamp').innerHTML = rowData.timestamp;
    document.getElementById('rp_invoice_id').value = rowData.id;
    $('#reject_action_modal').modal({
        backdrop: true,
        keyboard: true,
        focus: true,
        show: true,
...
function ApproveInvoice() {
    var invoice_id = document.getElementById('approve_invoice_id').innerHTML;
    var feedback = document.getElementById('approve_feedback').value;
    // if(feedback){
    $.ajax({
        url: "/system/Invoices/ProcurementToDo/approve/api/",
        method: "GET",
        dataType: "json",
        data: {
        ...
        success: function (t) {
            console.log(t);
            var ap_invoice_id = document.getElementById('ap_invoice_id').value;
            var e = $("#pendingInvoicesTbl");
            e.bootstrapTable('removeByUniqueId', ap_invoice_id)
            $('#approve_action_modal').modal('hide');
        },
    });
    // }else{
    //     document.getElementById('approve_note').classList.remove('d-none');
    // }
}


function RejectInvoice() {
    var invoice_id = document.getElementById('reject_invoice_id').innerHTML;
    var feedback = document.getElementById('reject_feedback').value;
    // if(feedback){
    $.ajax({
        url: "/system/Invoices/ProcurementToDo/reject/api/",
        method: "GET",
        dataType: "json",
        data: {
            'invoice_id': invoice_id,
        ...
        success: function (t) {
            console.log(t);
            var rp_invoice_id = document.getElementById('rp_invoice_id').value;
            var e = $("#pendingInvoicesTbl");
            e.bootstrapTable('removeByUniqueId', rp_invoice_id)
            $('#reject_action_modal').modal('hide');
        },
    });
    // }else{
    //     document.getElementById('reject_note').classList.remove('d-none');
    // }
}
...
//         // console.log(row);
//         // console.log(e.bootstrapTable('getSelections').length);
//         document.getElementById('selectedRows').innerHTML = e.bootstrapTable('getSelections').length;
//     },
...
//         document.getElementById('selectedRows').innerHTML = e.bootstrapTable('getSelections').length;
//     },
//     onTogglePagination: function (row) {
//         // console.log(row);
//         // console.log(e.bootstrapTable('getSelections').length);
//         document.getElementById('selectedRows').innerHTML = e.bootstrapTable('getSelections').length;
//     },
...
function ApprovedTimeSheet() {
    time_sheet_id = document.getElementById('am_sheetid').value;
    ...
    $.ajax({
        ...
        success: function (t) {
            // console.log(t);
            var e = $("#pendingInvoicesTbl");
            e.bootstrapTable('removeByUniqueId', time_sheet_id)
            $('#approve_action_modal').modal('hide');
        },
    });
}

function NotApprovedTimeSheet() {
    time_sheet_id = document.getElementById('rm_sheetid').value;
    // console.log(time_sheet_id);
    $.ajax({
...
document.getElementById("print_selected").addEventListener("click", function () {
    var selectedRows = [];
    selectedRows = $("#pendingInvoicesTbl").bootstrapTable("getSelections");
    // console.log(selectedRows);
    var printWindow = window.open("", "_blank");
    var currentDate = new Date();
    printWindow.document.open();
    printWindow.document.write(
        "<html><head><title>Pending Invoices Table</title>" +
        "<style>" +
    ...
    var columnNames = [];
    $("#pendingInvoicesTbl thead th").each(function () {
